...
<%      HttpSession sess = request.getSession();
        ...
        Connection myCon = DriverManager.getConnection("jdbc:mysql://localhost:3306/test1","root","password");
            ...
            String query = "select courseid,coursetitle,insId,coursedesc from course where insId=?;";
...
<div class="container" >
 <h3>Your Courses</h3>
<table class="node" id="node" style="width:98%">
<%
	 myRes.first();%>
  ...
  <tr>
    <td colspan="2"><i><%=myRes.getString("coursedesc")%></i></td>
  </tr>
 </table>
 <br/>
